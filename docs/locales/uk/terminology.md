...
Результат виконання всіх програм у реєстрі на певній [висоті тікання](#tick-height). Він включає щонайменше набір усіх [облікових записів](#account), які зберігають ненульові [нативні токени](#native-token).
...
Програма Solana, яка завантажує [програми на основі BPF](/docs/uk/core/programs#berkeley-packet-filter-bpf) в [блокчейн](#onchain-program), дозволяючи їм взаємодіяти з середовищем виконання.
...
[Блок](#block), який отримав [супербільшість](#supermajority) [голосів реєстру](#ledger-vote).
...
Виклик однієї [програми на блокчейні](#onchain-program) до іншої. Докладніше див. [Виклик між програмами](/docs/uk/core/cpi.md).
...
Проміжок часу, визначений кількістю [слотів](#slot), протягом яких діє [розклад лідерів](#leader-schedule).
...
Тривалість часу, протягом якої [валідатор](#validator) не може [голосувати](#ledger-vote) за інший [форк](#fork).
...
Виконуваний код у блокчейні Solana, який інтерпретує [інструкції](#instruction), надіслані в кожній [транзакції](#transaction), щоб читати та змінювати облікові записи, якими він управляє. Ці програми часто називають "[розумними контрактами](/docs/uk/core/programs.md)" на інших блокчейнах.
...
Обліковий запис, підписуючою владою якого є програма, і тому він не контролюється приватним ключем, як інші облікові записи.
...
Див. також [звільнення від оренди](#rent-exempt). Докладніше про оренду: [Що таке оренда?](/docs/uk/intro/rent.md).
