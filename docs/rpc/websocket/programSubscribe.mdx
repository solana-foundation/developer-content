...
:::info The resultant account must meet **ALL** filter criteria to be included
...
- `base58` is slow.
- [`jsonParsed`](/api/http#parsed-responses">) encoding attempts to use
...
[getProgramAccounts](/api/http#getprogramaccounts) RPC HTTP method.
