...
:::info Currently, a node's prioritization-fee cache stores data from up to 150
blocks. :::
...
:::note If this parameter is provided, the response will reflect a fee to land a
...
- `prioritizationFee: <u64>` - the per-compute-unit fee paid by at least one
