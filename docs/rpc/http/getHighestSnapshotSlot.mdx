...
:::caution NEW: This method is only available in solana-core v1.9 or newer.
Please use [getSnapshotSlot](/api/http#getsnapshotslot) for solana-core v1.8 :::
...
- `incremental: <u64|null>` - Highest incremental snapshot slot _based on_
  `full`
