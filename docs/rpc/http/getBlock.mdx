...
review [Anatomy of a Transaction](https://solana.com/docs/core/transactions) to
learn about transactions on Solana.
...
- `signatures: <array[string]>` - A list of base-58 encoded signatures applied
  ...
  [transaction id](https://solana.com/docs/terminology#transaction-id).
