...
export default function Page() {
  return (
    <>
      <Head>
        <title>Solana Blockchain Developer Resources</title>
      </Head>
      ...
      <main className="items-center max-w-6xl p-8 mx-auto space-y-8 md:py-16">
        ...
        <section className="grid justify-center gap-6 mx-auto md:grid-cols-3">
          ...
          >
            ...
            <p>
              Read and explore the core Solana blockchain documentation,
              including the Solana programming model and RPC API.
            </p>
          </Link>
          <Link
          ...
          >
            ...
            <p>
              A collection of resources for learning in the Solana ecosystem,
              from education guides to popular ecosystem tooling.
            </p>
          </Link>
        </section>
        ...
        <div className="!bg-yellow-800 !border-yellow-600 card">
          ...
          <p className="!text-white">
            ...
            would need to know and understand to build on Solana. Including
            things like the Solana programming model&apos;s{" "}
