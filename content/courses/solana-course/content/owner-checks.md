...
your program. This would let them effectively spoof your program into thinking
that they are the authorized admin for your program.
...
In this demo we’ll use two programs to demonstrate how a missing owner check
could allow a fake account to drain the tokens from a simplified token “vault”
account (note that this is very similar to the demo from the Signer
...
Without the owner check, this malicious user will be able to pass in the vault
