...
Metaplex where asset details such as the owner, name, uri e.t.c are stored on a 
single account. You can read a more detailed guide [here](/content/courses/tokens-and-nfts/nfts-with-metaplex-core.md)
</Callout>
