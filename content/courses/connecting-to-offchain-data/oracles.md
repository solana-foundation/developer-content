...
There are many
[Oracle providers on Solana](https://solana.com/ecosystem/explore?categories=oracle).
Two of the most popular ones are [Pyth](https://pyth.network) and
...
This feed is available on **Solana devnet/mainnet** with a `pubkey`
...
That’s the gist of the deposit instructions! The final result of the
...
instructions should be finished, and an error should be returned.
