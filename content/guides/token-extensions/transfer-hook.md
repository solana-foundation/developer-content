...
The counter PDA in this case is created in the initialize hook. If you want this
to work for every account you probably need to add a function on your website to
create this account beforehand.
