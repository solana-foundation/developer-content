...
```bash
spl-token create-token --program-id TokenzQdBNbLqP5VEhdkAS6EPFLC1PHnBqCXEpPxuEb --enable-metadata nice-keypair.json
```
...
```bash
spl-token transfer nicypxn7W5XRdG3jsNopVTgUvNHHmppUZbr7YHG9nfr 10 friendAddress --fund-recipient
```
