...
description: With Token Extensions, it is possible to close token mint accounts by initializing the MintCloseAuthority extension before initializing the mint.
keywords:
  - token 2022
  - token extensions
  - token program
